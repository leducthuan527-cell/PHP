        ...
        const imageData = [
            {
                ...
                description: "Kẻ hủy diệt đường đua với 1800 mã lực"
            },
            {
                title: "Ferrari 499p",
                description: "Chiếc xe chiến thắng LeMans của nhà Ferrari"
            },
            {
                title: "Lamborghini Revuelto",
                description: "Siêu xe hybrid hiện đại kết hợp động cơ V12 mạnh mẽ với thiết kế tương lai và khí động học tiên tiến"
            },
            {
                title: "Porsche 919 EVO",
                description: "Chiếc xe giữ kỷ lục ở trường đua Nürburgring, được thiết kế để đạt tốc độ và chính xác tuyệt đối trên các giải endurance. "
            },
            {
                title: "Koenigsegg Sadair Spear",
                description: "Siêu xe hypercar với sức mạnh cực đại, cấu trúc siêu nhẹ và tốc độ tối đa ấn tượng."
            },
            {
                title: "Hennessey Venom F5",
                description: "Siêu xe Mỹ được chế tạo để vượt mốc 300 mph với động cơ V8 twin-turbo cực khủng."
            },
            {
                title: "W Motors Lykan Hypersport",
                description: "Siêu xe sang trọng kết hợp thiết kế độc đáo, hiệu năng cao và trang bị xa xỉ dành cho những nhà sưu tập."
            }
        ];
